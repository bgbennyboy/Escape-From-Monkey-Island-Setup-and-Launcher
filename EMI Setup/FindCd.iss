...
const
	UniqueFile = 'Monkey4\MonkeyData\voiceMel.m4b';
...
begin
	...
	begin
		//MsgBox('Found it !!!!', mbError, MB_OK);
	end
	else
	begin
		while FindUniqueFile() = '' do
		begin
			if MsgBox('Please insert Escape From Monkey Island CD 1 in any drive and press OK.' + Chr(13) + Chr(13) + 'Or press cancel to exit setup.', mbConfirmation, MB_OKCANCEL or MB_DEFBUTTON1) = IDOK then
